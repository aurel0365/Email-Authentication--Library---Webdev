            ...
            <div class="bg-white shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-4 bg-green-50 border-l-4 border-green-500 p-4 text-green-700">
                        {{ __("You're successfully logged in to the Admin Panel. You can manage users and perform other administrative tasks.") }}
                    </div>

                    <div class="mt-6 flex items-center">
                        <a href="{{ route('users.index') }}" class="inline-flex items-center text-blue-500 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            ...
                            <span class="text-lg font-medium">{{ __('Manage Users') }}</span>
                        </a>
                    </div>
                </div>
            </div>
